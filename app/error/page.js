    ...
    switch (type) {
      case 'confirmation_failed':
        return {
          ...
          message: 'We could not verify your email address. The link may be expired or invalid.',
          action: 'Try resending confirmation email or contact support.'
        };
      case 'unauthorized':
        return {
          title: 'Access Denied',
          message: 'You are not authorized to access this resource.',
          action: 'Please login with valid credentials.'
        };
      case 'token_expired':
        return {
          title: 'Link Expired',
