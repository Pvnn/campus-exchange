    ...
    <div className="max-w-3xl mx-auto p-6">
      ...
      <div className="mb-8">
        <input
          ...
          className="w-full border rounded-lg p-3 bg-transparent text-black placeholder-gray-500"
        />
      </div>
      ...
      {resources.length === 0 ? (
        ...
        <div className="space-y-6">
          {resources.map(({ id, name }) => (
            <div key={id} className="bg-white border rounded-lg shadow-sm p-5">
              <h2 className="text-xl font-semibold mb-3 text-black">{name}</h2>
